    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                const activeWorkers = (company.members || []).filter((m) => m.is_active && m.role !== 'manager').length;
                const activeManagers = (company.members || []).filter((m) => m.is_active && m.role === 'manager').length;
